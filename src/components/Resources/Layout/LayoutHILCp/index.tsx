// 通用布局4： header+input+label+content 布局3略微变化
import React,{ useState } from 'react';
import { Input } from 'antd';
import { SearchOutlined } from '@ant-design/icons';
import './index.less';

interface LayoutHILCpProps {
  selectTab: number,
  selectSubTab: number,
  showSpread: boolean,
  placeHolder: string,
...
const LayoutHILCp: React.FC<LayoutHILCpProps> = (props) => {
  const {
    selectTab,
    selectSubTab,
    showSpread,
  ...
  return (
    <div className='layout-hilcp'>
      <header className='layout-hilcp__header'>
        <div className='layout-hilcp__content'>
          <div className='layout-hilcp__menu'>
          ...
          <div className='layout-hilcp__menu-input'>
            <Input
              prefix={<SearchOutlined style={{ color: '#b4b4b4' }}/>}
              className='menu-input__antd-input'
              placeholder={placeHolder} />
          </div>
          <div className='layout-hilcp__second-menu'>
